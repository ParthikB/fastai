...
def untar_data(url:str, fname:PathOrStr=None, dest:PathOrStr=None, data=True, force_download=False, verbose=True) -> Path:
    ...
    if not dest.exists():
        ...
        if verbose: print('.tar file downloaded. Extracting the contents...)
